...
contract UpgradeBridgeScript is Script {
    function run() public{

        uint256  bridgeOwnerPk= vm.envUint("BRIDGE_OWNER_PRIVATE_KEY");
        address usdsBridge = vm.envAddress("USDS_FOREIGN_BRIDGE_IMPLEMENTATION");
        ...
        xdaiForeignBridge.upgradeTo(newVersion, usdsBridge);
        vm.stopBroadcast();
